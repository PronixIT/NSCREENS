<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="frmShortFilmReport.aspx.cs" Inherits="Admin_frmAdvatizmentReport" EnableEventValidation="false" %>
                                        ...
                                        <asp:GridView ID="gvSearchFilm" runat="server" AutoGenerateColumns="False" GridLines="None"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="View">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkView" runat="server" CssClass="fa fa-eye" CommandName='<%#Eval("Short_film_Id") %>' OnClick="lnkView_Click"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                    ...
                                    <asp:GridView ID="gvViews" runat="server" AutoGenerateColumns="False" GridLines="None"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Username">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblGridUsername" runat="server" Text='<%#Eval("Name") %>' />
                                                    <asp:Label ID="lblGridVisits_Id" runat="server" Text='<%#Eval("Visits_Id") %>' Visible="false" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="EmailId">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblGridEmailId" runat="server" Text='<%#Eval("IPAddress") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
