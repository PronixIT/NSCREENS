<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="frmCategory.aspx.cs" Inherits="Admin_frmCategory" EnableEventValidation="false"  %>
        ...
        <div class="col-xs-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">New Category Entry</h3>
                </div>
                                ...
                                <ContentTemplate>
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtCategory" runat="server" CssClass="form-control" TabIndex="1" />
                                            </div>
                                        </div>
                                        <%--<div class="form-group">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <asp:Panel ID="pnlGrid" runat="server">
                            <asp:UpdatePanel ID="UplCategory" runat="server">
                                <ContentTemplate>
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvCategory" runat="server" AutoGenerateColumns="False" GridLines="None"
                                            CssClass="table table-bordered table-hover table-striped" OnRowCommand="gvCategory_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Category">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblGridCategory" runat="server" Text='<%#Eval("Category_Name") %>' />
                                                        <asp:Label ID="lblGridCategoryId" runat="server" Text='<%#Eval("Category_Id") %>' Visible="false" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Is Active">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblGridCategoryIsactive" runat="server" Text='<%# Eval("Isactive").ToString().Equals("True") ? " Active " : " Inactive " %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                        ...
                        <ContentTemplate>
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" tabindex="500">
                                    &times;</button>
                                <h4 id="myModalLabel" class="modal-title">Update Category</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <asp:Label ID="lblUpdateCategory" runat="server" Text="Category :" CssClass="col-sm-4 control-label" />
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtUpdateCategory" runat="server" CssClass="form-control" TabIndex="501" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="radioer">
                                                <asp:RadioButton ID="rdbActiveYesCategory" runat="server" Text="Yes" CssClass="radio radio-inline"
                                                    GroupName="Category" TabIndex="502" />
                                                <asp:RadioButton ID="rdbActiveNoCategory" runat="server" Text="No" CssClass="radio radio-inline"
                                                    GroupName="Category" TabIndex="502" />
                                            </div>
                                        </div>
                                    </div>
