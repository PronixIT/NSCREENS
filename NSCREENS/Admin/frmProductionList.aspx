<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="frmProductionList.aspx.cs" Inherits="Admin_frmProductionList" EnableEventValidation="false" %>
            ...
            <ContentTemplate>
                <div class="col-md-12 col-sm-12">
                    <div class="latst-vid secondary-vid">
                        <div class="vid-heading overflow-hidden">
                            <div class="col-sm-6">
                                <span class="wow" data-wow-duration="0.8s">My Production
                                </span>
                            </div>
                                    ...
                                    <ItemTemplate>
                                        <div class="col-md-2 col-sm-3">
                                            <div class="latest-vid-img-container">
                                                ...
                                                <div class="vid-text">
                                                    <h1><asp:LinkButton ID="lnk" runat="server" OnClick="lnkMore_Click" CommandName='<%#Eval("Channel_Id") %>'>
                                                        <asp:Label ID="Label4" runat="server" Text='<%#Eval("Channel_Name") %>'></asp:Label></asp:LinkButton></h1>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="latst-vid secondary-vid">
                        <div class="vid-heading overflow-hidden">
                            <div class="col-sm-6">
                                <span class="wow" data-wow-duration="0.8s">Other Production List
                                </span>
                            </div>
                            <div class="col-sm-2">
