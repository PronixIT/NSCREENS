<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="frmState.aspx.cs" Inherits="Admin_frmState" EnableEventValidation="false" %>
        ...
        <div class="col-xs-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">New State/UT Entry</h3>
                </div>
                                ...
                                <ContentTemplate>
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:DropDownList ID="ddlCountry" runat="server" CssClass="form-control" TabIndex="1" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="table-responsive">
                        <asp:Panel ID="pnlGrid" runat="server">
                            <asp:UpdatePanel ID="UplState" runat="server">
                                <ContentTemplate>
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvState" runat="server" AutoGenerateColumns="False" GridLines="None"
                                            CssClass="table table-bordered table-hover table-striped" OnRowCommand="gvState_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Country">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblGridCountry_Id" runat="server" Text='<%#Eval("Country_Id") %>' Visible="false" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                        ...
                        <ContentTemplate>
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" tabindex="500">
                                    &times;</button>
                                <h4 id="myModalLabel" class="modal-title">Update State/UT</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <asp:Label ID="Label1" runat="server" Text="Country :" CssClass="col-sm-4 control-label" />
                                        <div class="col-sm-6">
                                            <asp:DropDownList ID="ddlUpdateCountry" runat="server" CssClass="form-control" TabIndex="1" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <asp:Label ID="lblUpdateState" runat="server" Text="State/UT :" CssClass="col-sm-4 control-label" />
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtUpdateState" runat="server" CssClass="form-control" TabIndex="501" />
                                            <asp:Label ID="lblDName" runat="server" Visible="false" />
                                            <asp:Label ID="lblID" runat="server" Visible="false" />
                                            <asp:Label ID="lblDumpCountryId" runat="server" Visible="false" />
                                        </div>
                                    </div>
                                    <div class="form-group">
