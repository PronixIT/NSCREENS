<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="frmUpdateShortfilm.aspx.cs" Inherits="Admin_frmUpdateShortfilm" EnableEventValidation="false" %>
        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Update Short film</h3>
                </div>
                            ...
                            <asp:UpdatePanel ID="updAreaEntryModal" runat="server">
                                <ContentTemplate>
                                            ...
                                            <div class="col-xs-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <asp:Label ID="lblShortFilmId" runat="server" Visible="false" Text="0"/>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <asp:Button ID="btnSubmit" runat="server" Text="Update" CssClass="btn btn-info pull-right"
