...
public partial class Admin_frmDeleteAdvatizment : System.Web.UI.Page
{
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet objDataSet1 = MasterCode.RetrieveQuery("Update tbl_Advertisement set Isactive='false' where Advertisement_Id=" + lnk.CommandName);

            ShowNotification("Advertisement", "Advertisement Deleted Successfully..!", NotificationType.success);
