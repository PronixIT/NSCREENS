<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="frmPublishShortFilm.aspx.cs" Inherits="Admin_frmPublishShortFilm" EnableEventValidation="false" %>
                        ...
                        <ContentTemplate>
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" tabindex="500">
                                    &times;</button>
                                <h4 id="myModalLabel" class="modal-title">Publish Short Film</h4>
                            </div>
