<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="frmArtist.aspx.cs" Inherits="Admin_frmState" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
                                ...
                                <ContentTemplate>
                                    <div class="box-body">
                                        <div class="form-group">
                                            <asp:Label ID="lblArtist" runat="server" Text="Artist :" CssClass="col-sm-4 control-label" />
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtArtist" runat="server" CssClass="form-control" TabIndex="1" />
                                            </div>
                                        </div>
                                        <%--<div class="form-group">
        ...
        <div class="col-xs-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Artist List</h3>
                </div>
                <div class="panel-body">
                                ...
                                <ContentTemplate>
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvArtist" runat="server" AutoGenerateColumns="False" GridLines="None"
                                            CssClass="table table-bordered table-hover table-striped" OnRowCommand="gvArtist_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Artist">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblGridArtist" runat="server" Text='<%#Eval("Artist_Name") %>' />
                                                        <asp:Label ID="lblGridArtistId" runat="server" Text='<%#Eval("Artist_Id") %>' Visible="false" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <asp:UpdatePanel ID="uplUpdate" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="modal-body">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <asp:Label ID="lblUpdateArtist" runat="server" Text="Artist :" CssClass="col-sm-4 control-label" />
                                        <div class="col-sm-6">
