<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="frmTrailerApproval.aspx.cs" Inherits="Admin_frmTrailerApproval" EnableEventValidation="false" %>
        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Tailers List</h3>
                </div>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Title">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblGridTrailer_Id" runat="server" Text='<%#Eval("Trailer_Id") %>' Visible="false" />
                                                        <asp:Label ID="lblGridVideo" runat="server" Text='<%#Eval("Video") %>' Visible="false" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                        ...
                        <ContentTemplate>
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" tabindex="500">
                                    &times;</button>
                                <h4 id="myModalLabel" class="modal-title">Approval Trailer</h4>
                            </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" tabindex="500">
                                    &times;</button>
                                <h4 id="myModalLabel" class="modal-title">View Trailer</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblChannel_Name" runat="server" Text="Channel Name :" CssClass="col-sm-2 control-label" />
                                        <div class="col-sm-2">
