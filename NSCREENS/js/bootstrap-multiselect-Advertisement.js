    ...
    Multiselect.prototype = {
                ...
                if (options.length === 0) {
                    ...
                    options.each(function() {
                        ...
                        if ($(select).hasClass('multiselect-icon')) {
                            ...
                            label = '<div class="media"> <div class="media-left"><a href="#"> <img class="media-object" src="' + label.split("$")[1] + '"   width="50px;" height="50px;"></a></div> <div class="media-body"> <h4 class="media-heading">' + label.split("$")[0] + '</h4>' + label.split("$")[2] + '</div></div>';
                            //label = '<span><img src="http://www.nscreens.com/images/logo.png" width="50px;" height="50px;"/></span> ' + label;
                        }
        ...
        createOptionValue: function(element) {
            ...
            if ($(element).parent().hasClass('multiselect-icon') || $(element).parent().parent().hasClass('multiselect-icon')) {
                ...
                //alert(label.split("$")[1]);
                label = '<div class="media"> <div class="media-left"><a href="#"> <img class="media-object" src="' + label.split("$")[1] + '"   width="50px;" height="50px;"></a></div> <div class="media-body"> <h5 class="media-heading">' + label.split("$")[0] + '</h5>' + label.split("$")[2] + '</div></div>';
                //label = '<span><img src="' + label.split("$")[1] + '" width="50px;" height="50px;"/></span> ' + label.split("$")[0] + '<br><span>Test</span> ';
                //<span style="position: absolute;top: 85px;font-size: 10px;color: #b7b7b0;padding-left: 55px;">Navya</span>
                //http://localhost:3033/Artist_Photo/Ar1.jpg
            }
